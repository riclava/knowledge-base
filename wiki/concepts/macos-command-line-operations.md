...
tags: [concept, macos, apple, command-line, operations, system-administration, unix, bsd, launchctl, pmset, diskutil, networking, developer-tooling, homebrew, xcode, defaults]
---

macOS command-line operations 是通过 BSD/Unix 通用工具与 Apple 专用控制接口组合来检查、修改和自动化 macOS 系统状态的实践，覆盖系统信息、磁盘、网络、进程、服务、电源、用户、开发工具和桌面偏好设置。
