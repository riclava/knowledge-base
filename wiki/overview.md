...
- macOS 侧现在已覆盖安装 U 盘制作和一份广义命令速查，但仍缺少 Apple silicon / Intel 启动差异、`launchctl` domain model、APFS / Disk Utility、Homebrew 深度用法、SIP/TCC、Time Machine、系统恢复和数据迁移等专题。
